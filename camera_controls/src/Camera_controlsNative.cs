...
namespace camera_controlsNative
{
  /// <summary>
  /// The Camera_controls class provides a CLS compliant, Object (native) interface to
  ...
  public class Camera_controls : IDisposable
  {
      ...
      /// <summary>
      /// Provides a void output, 0-input Object interface to the stop_camera M-function.
      /// </summary>
      /// <remarks>
      /// </remarks>
      ///
      ...
      {
          mcr.EvaluateFunction(0, "stop_camera", new Object[]{});
      }


      /// <summary>
      /// Provides the standard 0-input Object interface to the stop_camera M-function.
      /// </summary>
      /// <remarks>
      /// </remarks>
      ...
      /// arguments.</returns>
      ///
      public Object[] stop_camera(int numArgsOut)
      {
          return mcr.EvaluateFunction(numArgsOut,
                                      "stop_camera", new Object[]{});
      }


      /// <summary>
      /// Provides a void output, 0-input Object interface to the preview_cam M-function.
      /// </summary>
      /// <remarks>
      /// </remarks>
      ///
      ...
      {
          mcr.EvaluateFunction(0, "preview_cam", new Object[]{});
      }


      /// <summary>
      /// Provides the standard 0-input Object interface to the preview_cam M-function.
      /// </summary>
      /// <remarks>
      /// </remarks>
      /// <param name="numArgsOut">The number of output arguments to return.</param>
      ...
      /// arguments.</returns>
      ///
      public Object[] preview_cam(int numArgsOut)
      {
          return mcr.EvaluateFunction(numArgsOut,
                                      "preview_cam", new Object[]{});
      }


      /// <summary>
      /// Provides a void output, 0-input Object interface to the start_camera
      /// M-function.
      /// </summary>
      /// <remarks>
      /// </remarks>
      ...
      {
          mcr.EvaluateFunction(0, "start_camera", new Object[]{});
      }


      /// <summary>
      /// Provides the standard 0-input Object interface to the start_camera M-function.
      /// </summary>
      /// <remarks>
      /// </remarks>
      /// <param name="numArgsOut">The number of output arguments to return.</param>
      ...
      /// arguments.</returns>
      ///
      public Object[] start_camera(int numArgsOut)
      {
          return mcr.EvaluateFunction(numArgsOut,
                                      "start_camera", new Object[]{});
      }
